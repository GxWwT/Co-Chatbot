...
ROOT_DIRECTORY = os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__))))
sys.path.append(ROOT_DIRECTORY)

import torch
from langchain.embeddings import HuggingFaceBgeEmbeddings
from database.filestore.MinioTools import MinioClient
from database.vector_database.MilvusTools import preprocess, insert_embeddings, MilvusClient
